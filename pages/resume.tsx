...
const ResumePage: NextPage = () => {
  return <>
    ...
    <main className="bg-amber-50 w-full min-h-screen p-4" >
      ...
      <Resume.Section name={"A Few Noteworthy Work Projects"}>
        <Resume.H3>STV News App (v5.0)</Resume.H3>
        <Resume.H3SubLine>BrightSignals</Resume.H3SubLine>
        ...
        <Resume.H3>Fringe Marketplace</Resume.H3>
        <Resume.H3SubLine>BrightSignals</Resume.H3SubLine>
