  ...
  return (
    <PageLayout rowLayout title="Home" >
      <section className="relative w-full aspect-square group max-w-xs mx-auto" >
        <Image src={profilePic} className="absolute" placeholder="blur" alt="My profile picture" />
      ...
      <section className="text-lg flex-1" >
        ...
        <Link href={"/about"} className="p-3 flex flex-row flex-nowrap justify-between max-w-md items-center cursor-pointer bg-white text-gray-900 transition-all hover:-skew-x-3" >
          <span className="mr-4" >
            Say no more
          </span>
